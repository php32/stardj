                ...
                <div class="row">
                    <div class="offset-lg-1 col-lg-5">
                        <div class="login_left-form-sec">
                            ...
                            <form class="singup-form-sec" action="{{ route('password.update') }}" method="POST">
                                @csrf
                                <input type="hidden" name="token" value="{{ $token }}" />
                                <div class="form-group email">
                                    <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus />
                                ...
                                <div class="form-group password">
                                    ...
                                    <label class="lab-style">{{ __('Password') }}</label>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group password">
                                    ...
                                    <label class="lab-style">{{ __('Confirm Password') }}</label>
                                </div>
