    ...
    <div class="dash-content-area-sec">
        <div class="container-fluid">
             <div class="settings-section">
                <form class="singup-form-sec mb-2" action="{{ route('package-store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <textarea class="form-control" placeholder="Discription" name="package_desc" value="{{ old('package_desc') }}"></textarea>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <textarea class="form-control" placeholder="Note" name="other_note" value="{{ old('other_note') }}"></textarea>
