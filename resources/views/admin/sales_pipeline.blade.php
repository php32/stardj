            ...
            <div class="board sales-pileline-section">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="board-column" data-id="lead_in">
                            <div class="board-column-container">
                                <div class="board-column-header">Lead In</div>
                                <div class="board-column-content-wrapper">
                                    <div class="board-column-content" data-id="lead_in">
                                        @foreach($users as $user)
                                            @if($user->sales_pipeline_status == '1')
                                                <div class="board-item" data-id="{{ $user->customer_id }}" onclick="viewDetails({{ $user->customer_id }})">
                                                    <div class="board-item-content">
                                                        <div class="sales-details-box">
                                                            ...
                                                            <div class="share-sec">
                                                                ...
                                                                <a href="#">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M7.73502 3.915C7.44098 3.15441 6.93051 2.49665 6.26671 2.02302C5.60292 1.54939 4.81489 1.28064 4.00002 1.25C3.18514 1.28064 2.39711 1.54939 1.73332 2.02302C1.06952 2.49665 0.559056 3.15441 0.265016 3.915C0.245158 3.96993 0.245158 4.03007 0.265016 4.085C0.559056 4.84559 1.06952 5.50335 1.73332 5.97698C2.39711 6.45061 3.18514 6.71936 4.00002 6.75C4.81489 6.71936 5.60292 6.45061 6.26671 5.97698C6.93051 5.50335 7.44098 4.84559 7.73502 4.085C7.75487 4.03007 7.75487 3.96993 7.73502 3.915ZM4.00002 6.25C2.67502 6.25 1.27502 5.2675 0.767516 4C1.27502 2.7325 2.67502 1.75 4.00002 1.75C5.32502 1.75 6.72502 2.7325 7.23252 4C6.72502 5.2675 5.32502 6.25 4.00002 6.25Z" fill="#868686"></path>
                                                                        <path d="M4 2.5C3.70333 2.5 3.41332 2.58797 3.16665 2.7528C2.91997 2.91762 2.72771 3.15189 2.61418 3.42597C2.50065 3.70006 2.47094 4.00166 2.52882 4.29264C2.5867 4.58361 2.72956 4.85088 2.93934 5.06066C3.14912 5.27044 3.41639 5.4133 3.70737 5.47118C3.99834 5.52906 4.29994 5.49935 4.57403 5.38582C4.84811 5.27229 5.08238 5.08003 5.2472 4.83336C5.41203 4.58668 5.5 4.29667 5.5 4C5.5 3.60218 5.34197 3.22064 5.06066 2.93934C4.77936 2.65804 4.39783 2.5 4 2.5ZM4 5C3.80222 5 3.60888 4.94135 3.44443 4.83147C3.27998 4.72159 3.15181 4.56541 3.07612 4.38268C3.00043 4.19996 2.98063 3.99889 3.01922 3.80491C3.0578 3.61093 3.15304 3.43275 3.29289 3.29289C3.43275 3.15304 3.61093 3.0578 3.80491 3.01921C3.99889 2.98063 4.19996 3.00043 4.38268 3.07612C4.56541 3.15181 4.72159 3.27998 4.83147 3.44443C4.94135 3.60888 5 3.80222 5 4C5 4.26522 4.89464 4.51957 4.70711 4.70711C4.51957 4.89464 4.26522 5 4 5Z" fill="#868686"></path>
                                                                    </svg>
                                                                    <span></span>
                                                                </a>
                                                                <a href="#">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        ...
                                                                        <path d="M3.99984 4.00003C4.18393 4.00003 4.33317 3.85079 4.33317 3.66669C4.33317 3.4826 4.18393 3.33336 3.99984 3.33336C3.81574 3.33336 3.6665 3.4826 3.6665 3.66669C3.6665 3.85079 3.81574 4.00003 3.99984 4.00003Z" fill="#868686"></path>
                                                                        <path d="M5.33333 4.00003C5.51743 4.00003 5.66667 3.85079 5.66667 3.66669C5.66667 3.4826 5.51743 3.33336 5.33333 3.33336C5.14924 3.33336 5 3.4826 5 3.66669C5 3.85079 5.14924 4.00003 5.33333 4.00003Z" fill="#868686"></path>
                                                                        <path d="M2.66683 4.00003C2.85092 4.00003 3.00016 3.85079 3.00016 3.66669C3.00016 3.4826 2.85092 3.33336 2.66683 3.33336C2.48273 3.33336 2.3335 3.4826 2.3335 3.66669C2.3335 3.85079 2.48273 4.00003 2.66683 4.00003Z" fill="#868686"></path>
                                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.6665 1H6.33317C6.88546 1 7.33317 1.44772 7.33317 2V5.33333C7.33317 5.88562 6.88546 6.33333 6.33317 6.33333H2.84984C2.7855 6.33086 2.72183 6.34707 2.6665 6.38L1.16984 7.28667C1.11839 7.3172 1.05966 7.33332 0.999837 7.33333C0.942574 7.33316 0.886322 7.31823 0.836504 7.29C0.731675 7.23108 0.666711 7.12025 0.666504 7V2C0.666504 1.44772 1.11422 1 1.6665 1ZM6.33333 5.66664C6.51743 5.66664 6.66667 5.5174 6.66667 5.33331V1.99997C6.66667 1.81588 6.51743 1.66664 6.33333 1.66664H1.66667C1.48257 1.66664 1.33333 1.81588 1.33333 1.99997V6.40997L2.33333 5.80997C2.4893 5.71605 2.66794 5.66649 2.85 5.66664H6.33333Z" fill="#868686"></path>
                                                                    </svg>
                                                                    <span>39</span>
                                                                </a>
                                                                <a href="#">
                                    ...
                                    <div class="Add-btn">
                                        <a class="btn" href="{{ route('customer-add') }}">
                                            ADD 
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="board-column style-two">
                            <div class="board-column-container">
                                <div class="board-column-header">Contact Made</div>
                                <div class="board-column-content-wrapper">
                                    <div class="board-column-content" data-id="contact_made">
                                        @foreach($users as $user)
                                        @if($user->sales_pipeline_status == '2')
                                        <div class="board-item"  data-id="{{ $user->customer_id }}" onclick="viewDetails({{ $user->customer_id }})">
                                            <div class="board-item-content">
                                                <div class="sales-details-box">
                                                    <h5>{{ $user->name }}</h5>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="board-column">
                            <div class="board-column-container">
                                <div class="board-column-header">Quoted</div>
                                <div class="board-column-content-wrapper">
                                    <div class="board-column-content" data-id="quoted">
                                        @foreach($users as $user)
                                        @if($user->sales_pipeline_status == '3')
                                        <div class="board-item" data-id="{{ $user->customer_id }}" onclick="viewDetails({{ $user->customer_id }})">
                                            <div class="board-item-content">
                                                <div class="sales-details-box">
                                                    <h5>{{ $user->name }}</h5>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="board-column style-two">
                            <div class="board-column-container">
                                ...
                                <div class="board-column-content-wrapper">
                                    <div class="board-column-content" data-id="added">
                                        @foreach($users as $user)
                                        @if($user->sales_pipeline_status == '4')
                                        <div class="board-item" data-id="{{ $user->customer_id }}" onclick="viewDetails({{ $user->customer_id }})">
                                            <div class="board-item-content">
                                                <div class="sales-details-box">
                                                    <h5>{{ $user->name }}</h5>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var gridElement = document.querySelector('.board-item');
        ...
        itemContainers.forEach(function (container) {
            ...
            .on('dragInit', function (item, element) {
            ...
            .on('dragReleaseEnd', function (item) {
                ...
                $.ajax({
                    url: "{{ route('sales-pipeline-update') }}",
                    method: 'post',
                    data: {
                        lead_id : lead_id,
    ...
    function viewDetails(id){
        var id = id;
        var url = '{{ route("customer_details", ":id") }}';
