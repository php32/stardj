      ...
      <!-- <div class="mobile-toogle">
        ...
        <div class="container-fluid">
             <div class="settings-section">
                <form class="singup-form-sec mb-2" action="{{ route('dj-update-details',$user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-6">
                         ...
                         <!-- <div class="col-lg-6">
                            ...
                            <div class="settings-profile-header mb-3">
                                @if($user->logo)
                                <div class="profile-nsda-images-box">
                                    <a href="#"><img id="logoprothumb" src="{{ asset('uploads/logos/' . $user->logo) }}"></a>
                                </div>
                                @else
                                <div class="profile-nsda-images-box">
                                ...
                                <div class="btn-profile-ndsa">
                                    ...
                                    <div class="Upload-btn"><a class="btn" href="#">Upload</a></div>
                                    <div class="Remove-btn"><a class="btn" href="#" id="remove-logo">Remove</a></div>
                    ...
                    <label for="title mt-5">Edit Details : </label>
                      <div class="row mt-4">
                           <div class="col-lg-6">
                     ...
                     <hr>
                     <form class="singup-form-sec mt-3 mb-2" action="{{ route('DJ-update-pass',$user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script>
    ...
    $("#remove-logo").click(function(e){
        logoprothumb.src='{{ asset('uploads/logos/logo.jpg') }}';
        $("#remove_logo").val('1');
    })
